 ...
 */
export declare abstract class BaseStorageService<T> implements StorageService<T> {
    private readonly defaultTranscoder;
    /**
     ...
     */
    constructor(defaultTranscoder: StorageTranscoder<T>);
    /**
     ...
     */
    get(key: string, decoder?: StorageDecoder<any>): any;
    /**
     ...
     */
    set(key: string, value: any, encoder?: StorageEncoder<any>): void;
    /**
